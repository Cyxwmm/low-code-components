...
const productPath = `/low-code-components@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('low-code-components', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'low-code-components': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
